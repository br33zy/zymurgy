...
##
##      E.g 5.24kg of pilsner malt (which yields 300 points per kg per litre) in a
##          27l fermenter, gives up 35.52 gravity points to give an original gravity
...
describe "Zymurgy" do
  before do
    ...
    @brew.stub!('fermentation_volume_litres').and_return(25)
    @brew.stub!('post_boil_volume_litres').and_return(27)
